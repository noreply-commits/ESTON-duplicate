  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch(
        `${API_URL}/api/admin/applications?search=${searchTerm}&status=${statusFilter}`,
        {
          headers: {
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredApplications.map(application => (
                  <tr key={application.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-2 py-4 whitespace-nowrap">
                      {application.course_name || application.course}
                    </td>
                    <td className="px-2 py-4 whitespace-nowrap">
                      <span
            ...
            <div className="px-6 py-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div>
                  ...
                  {selectedApplication.street_address_line_2}
                </div>
                <div>
                  <span className="font-semibold text-gray-700">
                    City/State/Province:
                  </span>{' '}
                  {selectedApplication.city_state_province}
                </div>
                <div>
                ...
                <div>
                  ...
                  {selectedApplication.reason_for_course}
                </div>
                <div>
                  <span className="font-semibold text-gray-700">
                    How Heard:
                  </span>{' '}
                  {selectedApplication.how_hear}
                </div>
                <div>
                  <span className="font-semibold text-gray-700">
                    Declaration:
                  </span>{' '}
                  {selectedApplication.declaration ? 'Yes' : 'No'}
                </div>
                <div>
                ...
                <div className="md:col-span-2">
                  ...
                  {selectedApplication.admin_notes || 'No notes'}
                </div>
              </div>
